...
En el disco S (\\\\datasrv) ir a la carpeta `S:\Proyectos\Smart Model` y bajarse a un directorio de Trabajo los comprimidos `Automat.zip` y la imagen  `bsm-studio-v10.3.tar.gz` con una buena herramienta de FTP.  
...
En ambos casos, modificar la versión `10.3` a la última disponible. 
