...
En algunos reportes comparamos la distribución de referencia con la distribución en la muestra de Desarrollo completa, 'Orig'. Esto nos permite identificar que medidas son *no significativos*. 
Si las medidas de 'Nueva' muestra son muy superiores a las de 'Orig' es probable que la variable no sea estable. 
