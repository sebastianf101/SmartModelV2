...
En esta sección evaluaremos la estabilidad de las variables por dos métodos.

En el primer método evaluamos la estabilidad de la distribución de la variable comparando los bines -distribución empírica- en la muestra de Entrenamiento y los bines en la nueva Muestra. Llamamos a los bines obtenidos en la muestra de Entrenamiento la distribución de referencia. 

En algunos reportes comparamos la distribución de referencia con la distribución en la muestra de Desarrollo completa, que llamamos 'Orig'. Esto nos permite identificar que medidas son *no significativas*. 
Si las medidas de la 'Nueva' muestra son muy superiores a las de 'Orig' es probable que la variable no sea estable. 
...
| 210 | Modelado | CargaRangos | Los niveles de riesgo por default no están ordenados. Editar los cortes manualmente. |
| 211 | Modelado | tabbins | No se generó ninguna variable candidata! Relajar restricciones? |
