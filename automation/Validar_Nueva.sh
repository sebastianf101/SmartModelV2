...
print_help() {
    ...
    echo "Ejecuta el Cuaderno de Validación de Nueva Muestra."
...
if [ ! -f "$INPUT_DIR/Muestra_Validación.txt" ]; then
    echo "Error: $INPUT_DIR no contiene archivo de datos 'Muestra_Validación.txt'"
    exit 1
fi
...
source ./Ejecutar_pipeline.sh pipeline_nueva

echo "*****************************************************************************"
echo "    Fin de proceso de Validación en Muestra Nueva sin errores detectados.    "
echo "*****************************************************************************"
