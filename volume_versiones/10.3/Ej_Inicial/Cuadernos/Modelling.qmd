...
if (requireNamespace("future", quietly = TRUE)) {
  ...
  cli::cli_alert_info("Parallel processing enabled with {n_cores} workers.")
}

# Setup Progress Reporting via JSON
Sys.setenv(PROGRESS_JSON_PATH = "/app/progress.json")
...
res.trad <- tryCatch({
  ...
  error = function(e) {
    if (any(train$.weight != 1)) {
      ...
      error_custom(paste0("El método ForwardK no convergió por causas internas. Detalle: ", e$message),
               ">"=cli::col_red("Cod 203"))
    }
    return(NULL)
  }
