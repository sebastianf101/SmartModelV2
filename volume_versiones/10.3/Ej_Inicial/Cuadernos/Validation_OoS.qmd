...
#### Niveles y Segmentación `r score_levels_version`

#### Archivo `r validation_oos_dataset_name`
...
if (tab$Q < par_iv_tot_min)
  log_error("La cantidad total en la Nueva Muestra {tab$malos} es inferior a  par_iv_tot_min ({par_iv_tot_min})")

if (tab$malos < par_iv_tot_gb_min)
  log_error("La cantidad de malos en la Nueva Muestra {tab$malos} es inferior a  par_iv_tot_gb_min ({par_iv_tot_gb_min})")

if (tab$malos < par_iv_cuantiles_gb_min)
  log_error("La cantidad de malos en la Nueva Muestra {tab$malos} es inferior a  par_iv_cuantiles_gb_min ({par_iv_cuantiles_gb_min})")

if (tab$malos < par_minpts_cat)
  log_error("La cantidad de malos en la Nueva Muestra {tab$malos} es inferior a  par_minpts_cat ({par_minpts_cat})")

if (tab$Q - tab$malos < par_iv_tot_gb_min)
  log_error("La cantidad de buenos en la Nueva Muestra {tab$Q - tab$malos} es inferior a  par_iv_tot_gb_min ({par_iv_tot_gb_min})")

if (tab$Q - tab$malos < par_iv_cuantiles_gb_min)
  log_error("La cantidad de buenos en la Nueva Muestra {tab$Q - tab$malos} es inferior a  par_iv_cuantiles_gb_min ({par_iv_cuantiles_gb_min})")

if (tab$Q - tab$malos < par_minpts_cat)
  log_error("La cantidad de buenos en la Nueva Muestra {tab$Q - tab$malos} es inferior a  par_minpts_cat ({par_minpts_cat})")
...
```{r Fin}
#| output: false
log_info("Fin del cuaderno de Validación en Nueva Muestra")
```
