...
#| label: "LoadEstabMod"
#| eval: !expr '!par_quick'
file_name <- "Estab_ivs_mod_InS.Rdat"
...
```
```{r ActSQL}
mod_2_sql_source(tab.co, tab.bins) -> sent_sql_new
#if (sent_sql_new != sent_sql) message("Aviso: Nuevos parámetros agregados en Implementación SQL ")
sent_sql_new -> sent_sql
```
